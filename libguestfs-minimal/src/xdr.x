...
struct guestfs_tune2fs_ll_args {
  string device<>;
};

struct guestfs_tune2fs_ll_ret {
...
struct guestfs_strings_ee_args {
  string encoding<>;
  string path<>;
};

struct guestfs_strings_ee_ret {
  guestfs_str stringsout<>;
};
...
struct guestfs_sfdisk_ll_args {
  string device<>;
};

struct guestfs_sfdisk_ll_ret {
  string partitions<>;
};
...
struct guestfs_ntfs3g_probe_args {
  bool rw;
  string device<>;
};

struct guestfs_ntfs3g_probe_ret {
  int status;
};
...
struct guestfs_wc_ll_args {
  string path<>;
};

struct guestfs_wc_ll_ret {
  int lines;
};

struct guestfs_wc_ww_args {
  string path<>;
};

struct guestfs_wc_ww_ret {
  int words;
};

struct guestfs_wc_cc_args {
  string path<>;
};

struct guestfs_wc_cc_ret {
  int chars;
};
...
struct guestfs_head_nn_args {
  int nrlines;
  string path<>;
};

struct guestfs_head_nn_ret {
  guestfs_str lines<>;
};
...
struct guestfs_tail_nn_args {
  int nrlines;
  string path<>;
};

struct guestfs_tail_nn_ret {
  guestfs_str lines<>;
};
...
struct guestfs_mkswap_ll_args {
  string label<>;
  string device<>;
};

struct guestfs_mkswap_uu_args {
  string uuid<>;
  string device<>;
};
...
struct guestfs_ln_ff_args {
  string target<>;
  string linkname<>;
};

struct guestfs_ln_ss_args {
  string target<>;
  string linkname<>;
};
...
struct guestfs_mke2journal_ll_args {
  int blocksize;
  string label<>;
  string device<>;
};

struct guestfs_mke2journal_uu_args {
  int blocksize;
  string uuid<>;
  string device<>;
};

struct guestfs_mke2fs_jj_args {
  string fstype<>;
  int blocksize;
  string device<>;
  string journal<>;
...
struct guestfs_resize2fs_mm_args {
  string device<>;
};
...
struct guestfs_list9p_ret {
  guestfs_str mounttags<>;
};

struct guestfs_mount9p_args {
  string mounttag<>;
  string mountpoint<>;
  string options<>;
};
...
enum guestfs_procedure {
  ...
  GUESTFS_PROC_STRINGS_EE = 95,
  GUESTFS_PROC_HEXDUMP = 96,
  GUESTFS_PROC_ZEROFREE = 97,
  GUESTFS_PROC_PVRESIZE = 98,
  GUESTFS_PROC_SFDISK_NN = 99,
  GUESTFS_PROC_SFDISK_LL = 100,
  ...
  GUESTFS_PROC_E2FSCK_FF = 108,
  GUESTFS_PROC_SLEEP = 109,
  GUESTFS_PROC_NTFS3G_PROBE = 110,
  GUESTFS_PROC_SH = 111,
  ...
  GUESTFS_PROC_WC_LL = 118,
  GUESTFS_PROC_WC_WW = 119,
  GUESTFS_PROC_WC_CC = 120,
  GUESTFS_PROC_HEAD = 121,
  GUESTFS_PROC_HEAD_NN = 122,
  GUESTFS_PROC_TAIL = 123,
  GUESTFS_PROC_TAIL_NN = 124,
  GUESTFS_PROC_DF = 125,
  GUESTFS_PROC_DF_HH = 126,
  GUESTFS_PROC_DU = 127,
  GUESTFS_PROC_INITRD_LIST = 128,
  GUESTFS_PROC_MOUNT_LOOP = 129,
  GUESTFS_PROC_MKSWAP = 130,
  GUESTFS_PROC_MKSWAP_LL = 131,
  GUESTFS_PROC_MKSWAP_UU = 132,
  GUESTFS_PROC_MKNOD = 133,
  GUESTFS_PROC_MKFIFO = 134,
  GUESTFS_PROC_MKNOD_BB = 135,
  GUESTFS_PROC_MKNOD_CC = 136,
  ...
  GUESTFS_PROC_LN = 164,
  GUESTFS_PROC_LN_FF = 165,
  GUESTFS_PROC_LN_SS = 166,
  ...
  GUESTFS_PROC_MKFS_BB = 187,
  GUESTFS_PROC_MKE2JOURNAL = 188,
  GUESTFS_PROC_MKE2JOURNAL_LL = 189,
  GUESTFS_PROC_MKE2JOURNAL_UU = 190,
  GUESTFS_PROC_MKE2FS_JJ = 191,
