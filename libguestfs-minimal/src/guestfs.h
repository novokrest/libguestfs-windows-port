...
struct guestfs_application_list {
  ProtobufCMessage base;
  size_t n_vals;
  struct guestfs_application **vals;
};
...
struct guestfs_application2_list {
  ProtobufCMessage base;
  size_t n_vals;
  struct guestfs_application2 **vals;
};
...
struct guestfs_btrfssubvolume_list {
  ProtobufCMessage base;
  size_t n_vals;
  struct guestfs_btrfssubvolume **vals;
};
...
struct guestfs_hivex_node_list {
  ProtobufCMessage base;
  size_t n_vals;
  struct guestfs_hivex_node **vals;
};
...
struct guestfs_hivex_value_list {
  ProtobufCMessage base;
  size_t n_vals;
  struct guestfs_hivex_value **vals;
};
...
struct guestfs_inotify_event_list {
  ProtobufCMessage base;
  size_t n_vals;
  struct guestfs_inotify_event **vals;
};
...
struct guestfs_lvm_lv {
  ProtobufCMessage base;
  char *lv_name;
  ProtobufCBinaryData lv_uuid; /* this is NOT nul-terminated, be careful when printing */
  char *lv_attr;
  int64_t lv_major;
  int64_t lv_minor;
...
struct guestfs_lvm_pv {
  ProtobufCMessage base;
  char *pv_name;
  ProtobufCBinaryData pv_uuid; /* this is NOT nul-terminated, be careful when printing */
  char *pv_fmt;
  uint64_t pv_size;
  uint64_t dev_size;
  uint64_t pv_free;
...
struct guestfs_lvm_vg {
  ProtobufCMessage base;
  char *vg_name;
  ProtobufCBinaryData vg_uuid; /* this is NOT nul-terminated, be careful when printing */
  char *vg_fmt;
  char *vg_attr;
  uint64_t vg_size;
  uint64_t vg_free;
...
extern GUESTFS_DLL_PUBLIC int guestfs_aug_setm (guestfs_h *g, const char *basee, const char *sub, const char *val);
...
#define GUESTFS_HAVE_DFH 1
extern GUESTFS_DLL_PUBLIC char *guestfs_dfh (guestfs_h *g);
...
#define GUESTFS_HAVE_LNF 1
extern GUESTFS_DLL_PUBLIC int guestfs_lnf (guestfs_h *g, const char *target, const char *linkname);

#define GUESTFS_HAVE_LNS 1
extern GUESTFS_DLL_PUBLIC int guestfs_lns (guestfs_h *g, const char *target, const char *linkname);
...
#define GUESTFS_HAVE_NTFS3GPROBE 1
extern GUESTFS_DLL_PUBLIC int guestfs_ntfs3gprobe (guestfs_h *g, int rw, const char *device);
...
#define GUESTFS_HAVE_RESIZE2FSM 1
extern GUESTFS_DLL_PUBLIC int guestfs_resize2fsm (guestfs_h *g, const char *device);
...
extern GUESTFS_DLL_PUBLIC char *guestfs_sfdiskl (guestfs_h *g, const char *device)
...
#define GUESTFS_HAVE_TUNE2FSL 1
extern GUESTFS_DLL_PUBLIC char **guestfs_tune2fsl (guestfs_h *g, const char *device);
...
#define GUESTFS_HAVE_WCC 1
extern GUESTFS_DLL_PUBLIC int guestfs_wcc (guestfs_h *g, const char *path);

#define GUESTFS_HAVE_WCL 1
extern GUESTFS_DLL_PUBLIC int guestfs_wcl (guestfs_h *g, const char *path);

#define GUESTFS_HAVE_WCW 1
extern GUESTFS_DLL_PUBLIC int guestfs_wcw (guestfs_h *g, const char *path);
...
struct guestfs_internal_mountable_list {
  ProtobufCMessage base;
  size_t n_vals;
  struct guestfs_internal_mountable **vals;
};
...
#define LIBGUESTFS_HAVE_LNF 1
#define LIBGUESTFS_HAVE_LNS 1
...
#define LIBGUESTFS_HAVE_NTFS3GPROBE 1
...
#define LIBGUESTFS_HAVE_RESIZE2FSM 1
...
#define LIBGUESTFS_HAVE_SFDISKL 1
...
#define LIBGUESTFS_HAVE_TUNE2FSL 1
...
#define LIBGUESTFS_HAVE_WCC 1
#define LIBGUESTFS_HAVE_WCL 1
#define LIBGUESTFS_HAVE_WCW 1
