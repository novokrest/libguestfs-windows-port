...
=head2 guestfs_get_shared_memory
...
See L</CALLS WITH OPTIONAL ARGUMENTS>.
 ...
 GUESTFS_MOUNT9P_OPTIONS, const char *options,
...
This is the "va_list variant" of L</guestfs_mount9p>.

See L</CALLS WITH OPTIONAL ARGUMENTS>.

=head2 guestfs_mount9p_argv
...
This is the "argv variant" of L</guestfs_mount9p>.
...
=head2 guestfs_set_shared_memory
...
See L</CALLS WITH OPTIONAL ARGUMENTS>.
 ...
 GUESTFS_SET_SHARED_MEMORY_SIZE, int size,
 GUESTFS_SET_SHARED_MEMORY_NAME, const char *name,
...
=head2 guestfs_set_shared_memory_va
...
This is the "va_list variant" of L</guestfs_set_shared_memory>.

See L</CALLS WITH OPTIONAL ARGUMENTS>.

=head2 guestfs_set_shared_memory_argv
...
This is the "argv variant" of L</guestfs_set_shared_memory>.
