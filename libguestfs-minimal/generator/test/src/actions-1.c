...
guestfs_list_partitions (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "list_partitions", &hdr, &err,
        (protobuf_proc_unpack) guestfs_list_partitions_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "list_partitions", "NULL");
...
guestfs_vgs_full (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "vgs_full", &hdr, &err,
        (protobuf_proc_unpack) guestfs_vgs_full_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "vgs_full", "NULL");
...
//    free (err.errno_string);
  ...
  ret_v = safe_malloc (g, sizeof (guestfs_lvm_vg))
;  convert_guestfs_lvm_vg_protobuf_to_xdr (ret->volgroups, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "vgs_full");
                    ...
                    const char *expr)
{
  ...
  r = guestfs___recv (g, "aug_defvar", &hdr, &err,
        (protobuf_proc_unpack) guestfs_aug_defvar_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "aug_defvar", "-1");
                ...
                const char *path)
{
  ...
  r = guestfs___recv (g, "exists", &hdr, &err,
        (protobuf_proc_unpack) guestfs_exists_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "exists", "-1");
...
guestfs_mounts (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "mounts", &hdr, &err,
        (protobuf_proc_unpack) guestfs_mounts_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mounts", "NULL");
...
guestfs_tune2fs_l (guestfs_h *g,
                   const char *device)
{
  guestfs_tune2fs_l_args args;
  guestfs_message_header *hdr;
  guestfs_message_error *err;
  guestfs_tune2fs_l_ret *ret;
  int serial;
  int r;
  int trace_flag = g->trace;
  struct trace_buffer trace_buffer;
  ...
  serial = guestfs___send (g, GUESTFS_PROC_TUNE2FS_L,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_tune2fs_l_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "tune2fs_l", "NULL");
  ...
  r = guestfs___recv (g, "tune2fs_l", &hdr, &err,
        (protobuf_proc_unpack) guestfs_tune2fs_l_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "tune2fs_l", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_superblock + 1))
  for (i = 0; i < n_superblock; ++i) {
     ret_v[i] = safe_strdup (g, ret->superblock[i]);
  }
  ret_v[n_superblock] = NULL;
  if (trace_flag) {
    size_t i;
...
guestfs_ntfs_3g_probe (guestfs_h *g,
                       ...
                       const char *device)
{
  guestfs_ntfs_3g_probe_args args;
  guestfs_message_header *hdr;
  guestfs_message_error *err;
  guestfs_ntfs_3g_probe_ret *ret;
  int serial;
  int r;
  int trace_flag = g->trace;
  struct trace_buffer trace_buffer;
  ...
  serial = guestfs___send (g, GUESTFS_PROC_NTFS_3G_PROBE,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_ntfs_3g_probe_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "ntfs_3g_probe", "-1");
  ...
  r = guestfs___recv (g, "ntfs_3g_probe", &hdr, &err,
        (protobuf_proc_unpack) guestfs_ntfs_3g_probe_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "ntfs_3g_probe", "-1");
                 ...
                 const char *tmpl)
{
  ...
  r = guestfs___recv (g, "mkdtemp", &hdr, &err,
        (protobuf_proc_unpack) guestfs_mkdtemp_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mkdtemp", "NULL");
              ...
              const char *path)
{
  ...
  r = guestfs___recv (g, "tail", &hdr, &err,
        (protobuf_proc_unpack) guestfs_tail_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "tail", "NULL");
                     ...
                     const char *path)
{
  ...
  r = guestfs___recv (g, "initrd_list", &hdr, &err,
        (protobuf_proc_unpack) guestfs_initrd_list_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "initrd_list", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_filenames + 1))
  for (i = 0; i < n_filenames; ++i) {
     ret_v[i] = safe_strdup (g, ret->filenames[i]);
  }
  ret_v[n_filenames] = NULL;
  if (trace_flag) {
    size_t i;
               ...
               const char *path)
{
  ...
  r = guestfs___recv (g, "zfile", &hdr, &err,
        (protobuf_proc_unpack) guestfs_zfile_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "zfile", "NULL");
                   ...
                   const char *path)
{
  ...
  r = guestfs___recv (g, "getxattrs", &hdr, &err,
        (protobuf_proc_unpack) guestfs_getxattrs_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "getxattrs", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this */
  ret_v = safe_malloc (g, sizeof (guestfs_xattr))
;  convert_guestfs_xattr_protobuf_to_xdr (ret->xattrs, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "getxattrs");
                        ...
                        const struct guestfs_grep_opts_argv *optargs)
{
  ...
  r = guestfs___recv (g, "grep", &hdr, &err,
        (protobuf_proc_unpack) guestfs_grep_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "grep", "NULL");
                ...
                const char *path)
{
  ...
  r = guestfs___recv (g, "zfgrep", &hdr, &err,
        (protobuf_proc_unpack) guestfs_zfgrep_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "zfgrep", "NULL");
                 ...
                 const char *path)
{
  ...
  r = guestfs___recv (g, "zegrepi", &hdr, &err,
        (protobuf_proc_unpack) guestfs_zegrepi_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "zegrepi", "NULL");
                  ...
                  const char *path)
{
  ...
  r = guestfs___recv (g, "realpath", &hdr, &err,
        (protobuf_proc_unpack) guestfs_realpath_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "realpath", "NULL");
...
guestfs_inotify_files (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "inotify_files", &hdr, &err,
        (protobuf_proc_unpack) guestfs_inotify_files_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "inotify_files", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_paths + 1))
  for (i = 0; i < n_paths; ++i) {
               ...
               size_t *size_r)
{
  ...
  r = guestfs___recv (g, "pread", &hdr, &err,
        (protobuf_proc_unpack) guestfs_pread_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "pread", "NULL");
                         ...
                         const char *device)
{
  ...
  r = guestfs___recv (g, "checksum_device", &hdr, &err,
        (protobuf_proc_unpack) guestfs_checksum_device_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "checksum_device", "NULL");
...
guestfs_get_umask (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "get_umask", &hdr, &err,
        (protobuf_proc_unpack) guestfs_get_umask_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "get_umask", "-1");
                      ...
                      const char *label)
{
  ...
  r = guestfs___recv (g, "findfs_label", &hdr, &err,
        (protobuf_proc_unpack) guestfs_findfs_label_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "findfs_label", "NULL");
                    ...
                    const char *path)
{
  ...
  r = guestfs___recv (g, "is_symlink", &hdr, &err,
        (protobuf_proc_unpack) guestfs_is_symlink_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "is_symlink", "-1");
                 ...
                 const char *path)
{
  ...
  r = guestfs___recv (g, "is_zero", &hdr, &err,
        (protobuf_proc_unpack) guestfs_is_zero_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "is_zero", "-1");
             ...
             const char *directory)
{
  ...
  r = guestfs___recv (g, "llz", &hdr, &err,
        (protobuf_proc_unpack) guestfs_llz_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "llz", "NULL");
                      ...
                      const char *device)
{
  ...
  r = guestfs___recv (g, "device_index", &hdr, &err,
        (protobuf_proc_unpack) guestfs_device_index_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "device_index", "-1");
...
guestfs_hivex_root (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "hivex_root", &hdr, &err,
        (protobuf_proc_unpack) guestfs_hivex_root_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "hivex_root", "-1");
                           ...
                           int64_t nodeh)
{
  ...
  r = guestfs___recv (g, "hivex_node_parent", &hdr, &err,
        (protobuf_proc_unpack) guestfs_hivex_node_parent_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "hivex_node_parent", "-1");
                           ...
                           size_t *size_r)
{
  ...
  r = guestfs___recv (g, "hivex_value_value", &hdr, &err,
        (protobuf_proc_unpack) guestfs_hivex_value_value_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "hivex_value_value", "NULL");
                                 ...
                                 const char *diskgroup)
{
  ...
  r = guestfs___recv (g, "ldmtool_diskgroup_disks", &hdr, &err,
        (protobuf_proc_unpack) guestfs_ldmtool_diskgroup_disks_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "ldmtool_diskgroup_disks", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_disks + 1))
  for (i = 0; i < n_disks; ++i) {
