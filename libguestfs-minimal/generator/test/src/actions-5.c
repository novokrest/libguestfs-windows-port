...
guestfs_lvs_full (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "lvs_full", &hdr, &err,
        (protobuf_proc_unpack) guestfs_lvs_full_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "lvs_full", "NULL");
...
//    free (err.errno_string);
  ...
  ret_v = safe_malloc (g, sizeof (guestfs_lvm_lv))
;  convert_guestfs_lvm_lv_protobuf_to_xdr (ret->logvols, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "lvs_full");
                  ...
                  const char *line)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_SFDISK_N,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_sfdisk_N_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "sfdisk_N", "-1");
...
guestfs_wc_l (guestfs_h *g,
              const char *path)
{
  guestfs_wc_l_args args;
  guestfs_message_header *hdr;
  guestfs_message_error *err;
  guestfs_wc_l_ret *ret;
  int serial;
  int r;
  int trace_flag = g->trace;
  struct trace_buffer trace_buffer;
  ...
  serial = guestfs___send (g, GUESTFS_PROC_WC_L,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_wc_l_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "wc_l", "-1");
  ...
  r = guestfs___recv (g, "wc_l", &hdr, &err,
        (protobuf_proc_unpack) guestfs_wc_l_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "wc_l", "-1");
...
guestfs_head_n (guestfs_h *g,
                ...
                const char *path)
{
  guestfs_head_n_args args;
  guestfs_message_header *hdr;
  guestfs_message_error *err;
  guestfs_head_n_ret *ret;
  int serial;
  int r;
  int trace_flag = g->trace;
  struct trace_buffer trace_buffer;
  ...
  serial = guestfs___send (g, GUESTFS_PROC_HEAD_N,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_head_n_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "head_n", "NULL");
  ...
  r = guestfs___recv (g, "head_n", &hdr, &err,
        (protobuf_proc_unpack) guestfs_head_n_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "head_n", "NULL");
                  ...
                  const char *device)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_MKSWAP_U,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_mkswap_U_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mkswap_U", "-1");
...
guestfs_mountpoints (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "mountpoints", &hdr, &err,
        (protobuf_proc_unpack) guestfs_mountpoints_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mountpoints", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_mps + 1))
  for (i = 0; i < n_mps; ++i) {
                ...
                const char *device)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_MKFS_B,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_mkfs_b_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mkfs_b", "-1");
                    ...
                    size_t *size_r)
{
  ...
  r = guestfs___recv (g, "initrd_cat", &hdr, &err,
        (protobuf_proc_unpack) guestfs_initrd_cat_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "initrd_cat", "NULL");
                   ...
                   const char *vgname)
{
  ...
  r = guestfs___recv (g, "vglvuuids", &hdr, &err,
        (protobuf_proc_unpack) guestfs_vglvuuids_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "vglvuuids", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_uuids + 1))
  for (i = 0; i < n_uuids; ++i) {
                           ...
                           int partnum)
{
  ...
  r = guestfs___recv (g, "part_get_bootable", &hdr, &err,
        (protobuf_proc_unpack) guestfs_part_get_bootable_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "part_get_bootable", "-1");
                               ...
                               const struct guestfs_is_blockdev_opts_argv *optargs)
{
  ...
  r = guestfs___recv (g, "is_blockdev", &hdr, &err,
        (protobuf_proc_unpack) guestfs_is_blockdev_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "is_blockdev", "-1");
                           ...
                           const struct guestfs_is_fifo_opts_argv *optargs)
{
  ...
  r = guestfs___recv (g, "is_fifo", &hdr, &err,
        (protobuf_proc_unpack) guestfs_is_fifo_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "is_fifo", "-1");
...
guestfs_list_md_devices (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "list_md_devices", &hdr, &err,
        (protobuf_proc_unpack) guestfs_list_md_devices_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "list_md_devices", "NULL");
                        ...
                        const char *device)
{
  ...
  r = guestfs___recv (g, "isoinfo_device", &hdr, &err,
        (protobuf_proc_unpack) guestfs_isoinfo_device_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "isoinfo_device", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this */
  ret_v = safe_malloc (g, sizeof (guestfs_isoinfo))
;  convert_guestfs_isoinfo_protobuf_to_xdr (ret->isodata, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "isoinfo_device");
                 ...
                 const char *md)
{
  ...
  r = guestfs___recv (g, "md_stat", &hdr, &err,
        (protobuf_proc_unpack) guestfs_md_stat_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "md_stat", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this */
  ret_v = safe_malloc (g, sizeof (guestfs_mdstat))
;  convert_guestfs_mdstat_protobuf_to_xdr (ret->devices, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "md_stat");
...
guestfs_nr_devices (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "nr_devices", &hdr, &err,
        (protobuf_proc_unpack) guestfs_nr_devices_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "nr_devices", "-1");
                  ...
                  const char *pathordevice)
{
  ...
  r = guestfs___recv (g, "xfs_info", &hdr, &err,
        (protobuf_proc_unpack) guestfs_xfs_info_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "xfs_info", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this */
  ret_v = safe_malloc (g, sizeof (guestfs_xfsinfo))
;  convert_guestfs_xfsinfo_protobuf_to_xdr (ret->info, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "xfs_info");
                         ...
                         const struct guestfs_xfs_repair_argv *optargs)
{
  ...
  r = guestfs___recv (g, "xfs_repair", &hdr, &err,
        (protobuf_proc_unpack) guestfs_xfs_repair_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "xfs_repair", "-1");
...
guestfs_list_disk_labels (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "list_disk_labels", &hdr, &err,
        (protobuf_proc_unpack) guestfs_list_disk_labels_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "list_disk_labels", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_labels + 1))
                                   ...
                                   const char *volume)
{
  ...
  r = guestfs___recv (g, "ldmtool_volume_partitions", &hdr, &err,
        (protobuf_proc_unpack) guestfs_ldmtool_volume_partitions_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "ldmtool_volume_partitions", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_partitions + 1))
  for (i = 0; i < n_partitions; ++i) {
     ret_v[i] = safe_strdup (g, ret->partitions[i]);
  }
  ret_v[n_partitions] = NULL;
  if (trace_flag) {
    size_t i;
                           ...
                           char *const *groups)
{
  ...
  r = guestfs___recv (g, "feature_available", &hdr, &err,
        (protobuf_proc_unpack) guestfs_feature_available_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "feature_available", "-1");
...
guestfs_journal_next (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "journal_next", &hdr, &err,
        (protobuf_proc_unpack) guestfs_journal_next_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "journal_next", "-1");
                      ...
                      int64_t skip)
{
  ...
  r = guestfs___recv (g, "journal_skip", &hdr, &err,
        (protobuf_proc_unpack) guestfs_journal_skip_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "journal_skip", "-1");
