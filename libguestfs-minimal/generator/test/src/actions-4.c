                ...
                const char *augpath)
{
  ...
  r = guestfs___recv (g, "aug_rm", &hdr, &err,
        (protobuf_proc_unpack) guestfs_aug_rm_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "aug_rm", "-1");
                    ...
                    const char *device)
{
  ...
  r = guestfs___recv (g, "get_e2uuid", &hdr, &err,
        (protobuf_proc_unpack) guestfs_get_e2uuid_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "get_e2uuid", "NULL");
                 ...
                 const char *path)
{
  ...
  r = guestfs___recv (g, "hexdump", &hdr, &err,
        (protobuf_proc_unpack) guestfs_hexdump_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "hexdump", "NULL");
                  ...
                  const char *command)
{
  ...
  r = guestfs___recv (g, "sh_lines", &hdr, &err,
        (protobuf_proc_unpack) guestfs_sh_lines_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "sh_lines", "NULL");
                 ...
                 const char *path)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_MKNOD_C,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_mknod_c_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mknod_c", "-1");
               ...
               int mask)
{
  ...
  r = guestfs___recv (g, "umask", &hdr, &err,
        (protobuf_proc_unpack) guestfs_umask_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "umask", "-1");
                    ...
                    const char *path)
{
  ...
  r = guestfs___recv (g, "lgetxattrs", &hdr, &err,
        (protobuf_proc_unpack) guestfs_lgetxattrs_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "lgetxattrs", "NULL");
               ...
               const char *path)
{
  ...
  r = guestfs___recv (g, "grepi", &hdr, &err,
        (protobuf_proc_unpack) guestfs_grepi_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "grepi", "NULL");
...
guestfs_mke2journal_U (guestfs_h *g,
                       ...
                       const char *device)
{
  guestfs_mke2journal_U_args args;
  guestfs_message_header *hdr;
  guestfs_message_error *err;
  int serial;
  int r;
  ...
  serial = guestfs___send (g, GUESTFS_PROC_MKE2JOURNAL_U,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_mke2journal_U_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mke2journal_U", "-1");
                  ...
                  const char *journal)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_MKE2FS_J,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_mke2fs_J_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mke2fs_J", "-1");
                             ...
                             const char *path)
{
  ...
  r = guestfs___recv (g, "case_sensitive_path", &hdr, &err,
        (protobuf_proc_unpack) guestfs_case_sensitive_path_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "case_sensitive_path", "NULL");
                             ...
                             char *const *names)
{
  ...
  r = guestfs___recv (g, "internal_lxattrlist", &hdr, &err,
        (protobuf_proc_unpack) guestfs_internal_lxattrlist_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "internal_lxattrlist", "NULL");
                ...
                const char *device)
{
  ...
  r = guestfs___recv (g, "pvuuid", &hdr, &err,
        (protobuf_proc_unpack) guestfs_pvuuid_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "pvuuid", "NULL");
                ...
                const char *device)
{
  ...
  r = guestfs___recv (g, "lvuuid", &hdr, &err,
        (protobuf_proc_unpack) guestfs_lvuuid_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "lvuuid", "NULL");
                         ...
                         int partnum)
{
  ...
  r = guestfs___recv (g, "part_get_mbr_id", &hdr, &err,
        (protobuf_proc_unpack) guestfs_part_get_mbr_id_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "part_get_mbr_id", "-1");
                     ...
                     const char *uuid)
{
  ...
  r = guestfs___recv (g, "findfs_uuid", &hdr, &err,
        (protobuf_proc_unpack) guestfs_findfs_uuid_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "findfs_uuid", "NULL");
                               ...
                               const char *lvname)
{
  ...
  r = guestfs___recv (g, "lvm_canonical_lv_name", &hdr, &err,
        (protobuf_proc_unpack) guestfs_lvm_canonical_lv_name_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "lvm_canonical_lv_name", "NULL");
...
guestfs_list_dm_devices (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "list_dm_devices", &hdr, &err,
        (protobuf_proc_unpack) guestfs_list_dm_devices_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "list_dm_devices", "NULL");
                         ...
                         const char *partition)
{
  ...
  r = guestfs___recv (g, "part_to_partnum", &hdr, &err,
        (protobuf_proc_unpack) guestfs_part_to_partnum_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "part_to_partnum", "-1");
               ...
               const char *device)
{
  ...
  r = guestfs___recv (g, "blkid", &hdr, &err,
        (protobuf_proc_unpack) guestfs_blkid_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "blkid", "NULL");
                             ...
                             int64_t nodeh)
{
  ...
  r = guestfs___recv (g, "hivex_node_children", &hdr, &err,
        (protobuf_proc_unpack) guestfs_hivex_node_children_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "hivex_node_children", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this */
  ret_v = safe_malloc (g, sizeof (guestfs_hivex_node))
;  convert_guestfs_hivex_node_protobuf_to_xdr (ret->nodehs, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "hivex_node_children");
...
guestfs_list_ldm_volumes (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "list_ldm_volumes", &hdr, &err,
        (protobuf_proc_unpack) guestfs_list_ldm_volumes_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "list_ldm_volumes", "NULL");
...
guestfs_ldmtool_scan (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "ldmtool_scan", &hdr, &err,
        (protobuf_proc_unpack) guestfs_ldmtool_scan_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "ldmtool_scan", "NULL");
                       ...
                       int partnum)
{
  ...
  r = guestfs___recv (g, "part_get_name", &hdr, &err,
        (protobuf_proc_unpack) guestfs_part_get_name_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "part_get_name", "NULL");
                              ...
                              char *const *names)
{
  ...
  r = guestfs___recv (g, "internal_lstatnslist", &hdr, &err,
        (protobuf_proc_unpack) guestfs_internal_lstatnslist_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "internal_lstatnslist", "NULL");
...
;  convert_guestfs_statns_protobuf_to_xdr (ret->statbufs, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "internal_lstatnslist");
