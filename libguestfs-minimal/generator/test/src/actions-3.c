...
guestfs_list_devices (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "list_devices", &hdr, &err,
        (protobuf_proc_unpack) guestfs_list_devices_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "list_devices", "NULL");
...
//    free (err.errno_string);
  ...
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_devices + 1))
  for (i = 0; i < n_devices; ++i) {
     ret_v[i] = safe_strdup (g, ret->devices[i]);
  }
  ret_v[n_devices] = NULL;
  if (trace_flag) {
    size_t i;
...
/* MUST FREE guestfs_header guestfs_message guestfs_<typ>_ret */
  return ret_v;
}
...
guestfs_vgs (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "vgs", &hdr, &err,
        (protobuf_proc_unpack) guestfs_vgs_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "vgs", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_volgroups + 1))
  for (i = 0; i < n_volgroups; ++i) {
     ret_v[i] = safe_strdup (g, ret->volgroups[i]);
  }
  ret_v[n_volgroups] = NULL;
  if (trace_flag) {
    size_t i;
                     ...
                     const char *val)
{
  ...
  r = guestfs___recv (g, "aug_defnode", &hdr, &err,
        (protobuf_proc_unpack) guestfs_aug_defnode_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "aug_defnode", "NULL");
...
//    free (err.errno_string);
  ...
  ret_v = safe_malloc (g, sizeof (guestfs_int_bool))
;  convert_guestfs_int_bool_protobuf_to_xdr (ret->nrnodescreated, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "aug_defnode");
                 ...
                 const char *augpath)
{
  ...
  r = guestfs___recv (g, "aug_get", &hdr, &err,
        (protobuf_proc_unpack) guestfs_aug_get_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "aug_get", "NULL");
                 ...
                 const char *path)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_MKDIR_P,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_mkdir_p_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mkdir_p", "-1");
                           ...
                           const struct guestfs_is_file_opts_argv *optargs)
{
  ...
  r = guestfs___recv (g, "is_file", &hdr, &err,
        (protobuf_proc_unpack) guestfs_is_file_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "is_file", "-1");
                          ...
                          const struct guestfs_is_dir_opts_argv *optargs)
{
  ...
  r = guestfs___recv (g, "is_dir", &hdr, &err,
        (protobuf_proc_unpack) guestfs_is_dir_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "is_dir", "-1");
                 ...
                 const char *path)
{
  ...
  r = guestfs___recv (g, "statvfs", &hdr, &err,
        (protobuf_proc_unpack) guestfs_statvfs_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "statvfs", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this */
  ret_v = safe_malloc (g, sizeof (guestfs_statvfs))
;  convert_guestfs_statvfs_protobuf_to_xdr (ret->statbuf, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "statvfs");
                        ...
                        const char *device)
{
  ...
  r = guestfs___recv (g, "blockdev_getsz", &hdr, &err,
        (protobuf_proc_unpack) guestfs_blockdev_getsz_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "blockdev_getsz", "-1");
                  ...
                  const char *path)
{
  ...
  r = guestfs___recv (g, "checksum", &hdr, &err,
        (protobuf_proc_unpack) guestfs_checksum_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "checksum", "NULL");
                     ...
                     const char *device)
{
  ...
  r = guestfs___recv (g, "get_e2label", &hdr, &err,
        (protobuf_proc_unpack) guestfs_get_e2label_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "get_e2label", "NULL");
...
guestfs_dmesg (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "dmesg", &hdr, &err,
        (protobuf_proc_unpack) guestfs_dmesg_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "dmesg", "NULL");
               ...
               const char *file2)
{
  ...
  r = guestfs___recv (g, "equal", &hdr, &err,
        (protobuf_proc_unpack) guestfs_equal_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "equal", "-1");
                 ...
                 const char *path)
{
  ...
  r = guestfs___recv (g, "strings", &hdr, &err,
        (protobuf_proc_unpack) guestfs_strings_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "strings", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_stringsout + 1))
  for (i = 0; i < n_stringsout; ++i) {
     ret_v[i] = safe_strdup (g, ret->stringsout[i]);
  }
  ret_v[n_stringsout] = NULL;
  if (trace_flag) {
    size_t i;
                  ...
                  const char *device)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_E2FSCK_F,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_e2fsck_f_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "e2fsck_f", "-1");
            ...
            const char *path)
{
  ...
  r = guestfs___recv (g, "du", &hdr, &err,
        (protobuf_proc_unpack) guestfs_du_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "du", "-1");
                 ...
                 const char *path)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_MKNOD_B,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_mknod_b_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mknod_b", "-1");
                ...
                const char *path)
{
  ...
  r = guestfs___recv (g, "fgrepi", &hdr, &err,
        (protobuf_proc_unpack) guestfs_fgrepi_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "fgrepi", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_lines + 1))
  for (i = 0; i < n_lines; ++i) {
                ...
                const char *path)
{
  ...
  r = guestfs___recv (g, "zgrepi", &hdr, &err,
        (protobuf_proc_unpack) guestfs_zgrepi_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "zgrepi", "NULL");
                           ...
                           int mask)
{
  ...
  r = guestfs___recv (g, "inotify_add_watch", &hdr, &err,
        (protobuf_proc_unpack) guestfs_inotify_add_watch_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "inotify_add_watch", "-1");
...
guestfs_getcon (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "getcon", &hdr, &err,
        (protobuf_proc_unpack) guestfs_getcon_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "getcon", "NULL");
                     ...
                     char *const *words)
{
  ...
  r = guestfs___recv (g, "echo_daemon", &hdr, &err,
        (protobuf_proc_unpack) guestfs_echo_daemon_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "echo_daemon", "NULL");
                  ...
                  const char *mountable)
{
  ...
  r = guestfs___recv (g, "vfs_uuid", &hdr, &err,
        (protobuf_proc_unpack) guestfs_vfs_uuid_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "vfs_uuid", "NULL");
                  ...
                  size_t *size_r)
{
  ...
  r = guestfs___recv (g, "getxattr", &hdr, &err,
        (protobuf_proc_unpack) guestfs_getxattr_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "getxattr", "NULL");
                        ...
                        const char *device)
{
  ...
  r = guestfs___recv (g, "is_zero_device", &hdr, &err,
        (protobuf_proc_unpack) guestfs_is_zero_device_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "is_zero_device", "-1");
                              ...
                              const char *fs)
{
  ...
  r = guestfs___recv (g, "btrfs_subvolume_list", &hdr, &err,
        (protobuf_proc_unpack) guestfs_btrfs_subvolume_list_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "btrfs_subvolume_list", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this */
  ret_v = safe_malloc (g, sizeof (guestfs_btrfssubvolume))
;  convert_guestfs_btrfssubvolume_protobuf_to_xdr (ret->subvolumes, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "btrfs_subvolume_list");
                      ...
                      const char *acltype)
{
  ...
  r = guestfs___recv (g, "acl_get_file", &hdr, &err,
        (protobuf_proc_unpack) guestfs_acl_get_file_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "acl_get_file", "NULL");
                      ...
                      const char *path)
{
  ...
  r = guestfs___recv (g, "cap_get_file", &hdr, &err,
        (protobuf_proc_unpack) guestfs_cap_get_file_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "cap_get_file", "NULL");
                             ...
                             const char *volume)
{
  ...
  r = guestfs___recv (g, "ldmtool_volume_type", &hdr, &err,
        (protobuf_proc_unpack) guestfs_ldmtool_volume_type_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "ldmtool_volume_type", "NULL");
                             ...
                             const char *volume)
{
  ...
  r = guestfs___recv (g, "ldmtool_volume_hint", &hdr, &err,
        (protobuf_proc_unpack) guestfs_ldmtool_volume_hint_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "ldmtool_volume_hint", "NULL");
                           ...
                           int partnum)
{
  ...
  r = guestfs___recv (g, "part_get_gpt_type", &hdr, &err,
        (protobuf_proc_unpack) guestfs_part_get_gpt_type_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "part_get_gpt_type", "NULL");
                         ...
                         const char *device)
{
  ...
  r = guestfs___recv (g, "is_whole_device", &hdr, &err,
        (protobuf_proc_unpack) guestfs_is_whole_device_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "is_whole_device", "-1");
                  ...
                  const char *val)
{
  ...
  r = guestfs___recv (g, "aug_setm", &hdr, &err,
        (protobuf_proc_unpack) guestfs_aug_setm_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "aug_setm", "-1");
...
guestfs_journal_get_realtime_usec (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "journal_get_realtime_usec", &hdr, &err,
        (protobuf_proc_unpack) guestfs_journal_get_realtime_usec_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "journal_get_realtime_usec", "-1");
                 ...
                 const char *path)
{
  ...
  r = guestfs___recv (g, "lstatns", &hdr, &err,
        (protobuf_proc_unpack) guestfs_lstatns_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "lstatns", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this */
  ret_v = safe_malloc (g, sizeof (guestfs_statns))
;  convert_guestfs_statns_protobuf_to_xdr (ret->statbuf, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "lstatns");
