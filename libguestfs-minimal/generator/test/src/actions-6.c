...
guestfs_lvs (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "lvs", &hdr, &err,
        (protobuf_proc_unpack) guestfs_lvs_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "lvs", "NULL");
...
//    free (err.errno_string);
  ...
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_logvols + 1))
  for (i = 0; i < n_logvols; ++i) {
     ret_v[i] = safe_strdup (g, ret->logvols[i]);
  }
  ret_v[n_logvols] = NULL;
  if (trace_flag) {
    size_t i;
              ...
              const char *path)
{
  ...
  r = guestfs___recv (g, "file", &hdr, &err,
        (protobuf_proc_unpack) guestfs_file_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "file", "NULL");
                        ...
                        const char *device)
{
  ...
  r = guestfs___recv (g, "blockdev_getro", &hdr, &err,
        (protobuf_proc_unpack) guestfs_blockdev_getro_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "blockdev_getro", "-1");
                         ...
                         const char *device)
{
  ...
  r = guestfs___recv (g, "blockdev_getbsz", &hdr, &err,
        (protobuf_proc_unpack) guestfs_blockdev_getbsz_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "blockdev_getbsz", "-1");
              ...
              const char *dest)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_CP_A,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_cp_a_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "cp_a", "-1");
...
guestfs_strings_e (guestfs_h *g,
                   ...
                   const char *path)
{
  guestfs_strings_e_args args;
  guestfs_message_header *hdr;
  guestfs_message_error *err;
  guestfs_strings_e_ret *ret;
  int serial;
  int r;
  int trace_flag = g->trace;
  struct trace_buffer trace_buffer;
  ...
  serial = guestfs___send (g, GUESTFS_PROC_STRINGS_E,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_strings_e_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "strings_e", "NULL");
  ...
  r = guestfs___recv (g, "strings_e", &hdr, &err,
        (protobuf_proc_unpack) guestfs_strings_e_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "strings_e", "NULL");
                                ...
                                const char *device)
{
  ...
  r = guestfs___recv (g, "sfdisk_kernel_geometry", &hdr, &err,
        (protobuf_proc_unpack) guestfs_sfdisk_kernel_geometry_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "sfdisk_kernel_geometry", "NULL");
...
guestfs_wc_c (guestfs_h *g,
              const char *path)
{
  guestfs_wc_c_args args;
  guestfs_message_header *hdr;
  guestfs_message_error *err;
  guestfs_wc_c_ret *ret;
  int serial;
  int r;
  int trace_flag = g->trace;
  struct trace_buffer trace_buffer;
  ...
  serial = guestfs___send (g, GUESTFS_PROC_WC_C,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_wc_c_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "wc_c", "-1");
  ...
  r = guestfs___recv (g, "wc_c", &hdr, &err,
        (protobuf_proc_unpack) guestfs_wc_c_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "wc_c", "-1");
              ...
              const char *path)
{
  ...
  r = guestfs___recv (g, "head", &hdr, &err,
        (protobuf_proc_unpack) guestfs_head_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "head", "NULL");
...
guestfs_tail_n (guestfs_h *g,
                ...
                const char *path)
{
  guestfs_tail_n_args args;
  guestfs_message_header *hdr;
  guestfs_message_error *err;
  guestfs_tail_n_ret *ret;
  int serial;
  int r;
  int trace_flag = g->trace;
  struct trace_buffer trace_buffer;
  ...
  serial = guestfs___send (g, GUESTFS_PROC_TAIL_N,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_tail_n_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "tail_n", "NULL");
  ...
  r = guestfs___recv (g, "tail_n", &hdr, &err,
        (protobuf_proc_unpack) guestfs_tail_n_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "tail_n", "NULL");
...
guestfs_df (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "df", &hdr, &err,
        (protobuf_proc_unpack) guestfs_df_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "df", "NULL");
                  ...
                  const char *device)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_MKSWAP_L,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_mkswap_L_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mkswap_L", "-1");
               ...
               const char *path)
{
  ...
  r = guestfs___recv (g, "fgrep", &hdr, &err,
        (protobuf_proc_unpack) guestfs_fgrep_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "fgrep", "NULL");
                ...
                const char *path)
{
  ...
  r = guestfs___recv (g, "egrepi", &hdr, &err,
        (protobuf_proc_unpack) guestfs_egrepi_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "egrepi", "NULL");
                ...
                const char *path)
{
  ...
  r = guestfs___recv (g, "zegrep", &hdr, &err,
        (protobuf_proc_unpack) guestfs_zegrep_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "zegrep", "NULL");
...
guestfs_inotify_read (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "inotify_read", &hdr, &err,
        (protobuf_proc_unpack) guestfs_inotify_read_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "inotify_read", "NULL");
...
//    free (err.errno_string);
  ...
  ret_v = safe_malloc (g, sizeof (guestfs_inotify_event))
;  convert_guestfs_inotify_event_protobuf_to_xdr (ret->events, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "inotify_read");
...
guestfs_mke2journal_L (guestfs_h *g,
                       ...
                       const char *device)
{
  guestfs_mke2journal_L_args args;
  guestfs_message_header *hdr;
  guestfs_message_error *err;
  int serial;
  int r;
  ...
  serial = guestfs___send (g, GUESTFS_PROC_MKE2JOURNAL_L,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_mke2journal_L_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mke2journal_L", "-1");
                  ...
                  const char *mountable)
{
  ...
  r = guestfs___recv (g, "vfs_type", &hdr, &err,
        (protobuf_proc_unpack) guestfs_vfs_type_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "vfs_type", "NULL");
                               ...
                               char *const *names)
{
  ...
  r = guestfs___recv (g, "internal_readlinklist", &hdr, &err,
        (protobuf_proc_unpack) guestfs_internal_readlinklist_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "internal_readlinklist", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_links + 1))
  for (i = 0; i < n_links; ++i) {
                  ...
                  const char *file)
{
  ...
  r = guestfs___recv (g, "filesize", &hdr, &err,
        (protobuf_proc_unpack) guestfs_filesize_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "filesize", "-1");
...
guestfs_available_all_groups (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "available_all_groups", &hdr, &err,
        (protobuf_proc_unpack) guestfs_available_all_groups_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "available_all_groups", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_groups + 1))
                      ...
                      size_t *size_r)
{
  ...
  r = guestfs___recv (g, "pread_device", &hdr, &err,
        (protobuf_proc_unpack) guestfs_pread_device_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "pread_device", "NULL");
                   ...
                   size_t *size_r)
{
  ...
  r = guestfs___recv (g, "lgetxattr", &hdr, &err,
        (protobuf_proc_unpack) guestfs_lgetxattr_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "lgetxattr", "NULL");
...
guestfs_list_9p (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "list_9p", &hdr, &err,
        (protobuf_proc_unpack) guestfs_list_9p_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "list_9p", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_mounttags + 1))
  for (i = 0; i < n_mounttags; ++i) {
     ret_v[i] = safe_strdup (g, ret->mounttags[i]);
  }
  ret_v[n_mounttags] = NULL;
  if (trace_flag) {
    size_t i;
                   ...
                   const char *md)
{
  ...
  r = guestfs___recv (g, "md_detail", &hdr, &err,
        (protobuf_proc_unpack) guestfs_md_detail_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "md_detail", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_info + 1))
  for (i = 0; i < n_info; ++i) {
                 ...
                 const char *isofile)
{
  ...
  r = guestfs___recv (g, "isoinfo", &hdr, &err,
        (protobuf_proc_unpack) guestfs_isoinfo_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "isoinfo", "NULL");
                              ...
                              const char *filesystem)
{
  ...
  r = guestfs___recv (g, "filesystem_available", &hdr, &err,
        (protobuf_proc_unpack) guestfs_filesystem_available_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "filesystem_available", "-1");
                         ...
                         int64_t nodeh)
{
  ...
  r = guestfs___recv (g, "hivex_node_name", &hdr, &err,
        (protobuf_proc_unpack) guestfs_hivex_node_name_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "hivex_node_name", "NULL");
                           ...
                           int64_t nodeh)
{
  ...
  r = guestfs___recv (g, "hivex_node_values", &hdr, &err,
        (protobuf_proc_unpack) guestfs_hivex_node_values_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "hivex_node_values", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this */
  ret_v = safe_malloc (g, sizeof (guestfs_hivex_value))
;  convert_guestfs_hivex_value_protobuf_to_xdr (ret->valuehs, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "hivex_node_values");
              ...
              const char *path)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_RM_F,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_rm_f_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "rm_f", "-1");
                     ...
                     const struct guestfs_mktemp_argv *optargs)
{
  ...
  r = guestfs___recv (g, "mktemp", &hdr, &err,
        (protobuf_proc_unpack) guestfs_mktemp_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mktemp", "NULL");
...
guestfs_list_ldm_partitions (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "list_ldm_partitions", &hdr, &err,
        (protobuf_proc_unpack) guestfs_list_ldm_partitions_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "list_ldm_partitions", "NULL");
                                  ...
                                  const char *mountable)
{
  ...
  r = guestfs___recv (g, "internal_parse_mountable", &hdr, &err,
        (protobuf_proc_unpack) guestfs_internal_parse_mountable_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "internal_parse_mountable", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this */
  ret_v = safe_malloc (g, sizeof (guestfs_internal_mountable))
;  convert_guestfs_internal_mountable_protobuf_to_xdr (ret->mountable, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "internal_parse_mountable");
