...
guestfs_pvs_full (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "pvs_full", &hdr, &err,
        (protobuf_proc_unpack) guestfs_pvs_full_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "pvs_full", "NULL");
...
//    free (err.errno_string);
  ...
  ret_v = safe_malloc (g, sizeof (guestfs_lvm_pv))
;  convert_guestfs_lvm_pv_protobuf_to_xdr (ret->physvols, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "pvs_full");
                 ...
                 char *const *arguments)
{
  ...
  r = guestfs___recv (g, "command", &hdr, &err,
        (protobuf_proc_unpack) guestfs_command_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "command", "NULL");
                        ...
                        const char *device)
{
  ...
  r = guestfs___recv (g, "blockdev_getss", &hdr, &err,
        (protobuf_proc_unpack) guestfs_blockdev_getss_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "blockdev_getss", "-1");
                            ...
                            const char *device)
{
  ...
  r = guestfs___recv (g, "blockdev_getsize64", &hdr, &err,
        (protobuf_proc_unpack) guestfs_blockdev_getsize64_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "blockdev_getsize64", "-1");
               ...
               char *const *extraargs)
{
  ...
  r = guestfs___recv (g, "debug", &hdr, &err,
        (protobuf_proc_unpack) guestfs_debug_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "debug", "NULL");
                              ...
                              const char *device)
{
  ...
  r = guestfs___recv (g, "sfdisk_disk_geometry", &hdr, &err,
        (protobuf_proc_unpack) guestfs_sfdisk_disk_geometry_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "sfdisk_disk_geometry", "NULL");
            ...
            const char *command)
{
  ...
  r = guestfs___recv (g, "sh", &hdr, &err,
        (protobuf_proc_unpack) guestfs_sh_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "sh", "NULL");
                     ...
                     const char *pattern)
{
  ...
  r = guestfs___recv (g, "glob_expand", &hdr, &err,
        (protobuf_proc_unpack) guestfs_glob_expand_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "glob_expand", "NULL");
                 ...
                 const char *dir)
{
  ...
  r = guestfs___recv (g, "readdir", &hdr, &err,
        (protobuf_proc_unpack) guestfs_readdir_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "readdir", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this */
  ret_v = safe_malloc (g, sizeof (guestfs_dirent))
;  convert_guestfs_dirent_protobuf_to_xdr (ret->entries, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "readdir");
               ...
               const char *path)
{
  ...
  r = guestfs___recv (g, "egrep", &hdr, &err,
        (protobuf_proc_unpack) guestfs_egrep_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "egrep", "NULL");
               ...
               const char *path)
{
  ...
  r = guestfs___recv (g, "zgrep", &hdr, &err,
        (protobuf_proc_unpack) guestfs_zgrep_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "zgrep", "NULL");
                  ...
                  const char *path)
{
  ...
  r = guestfs___recv (g, "readlink", &hdr, &err,
        (protobuf_proc_unpack) guestfs_readlink_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "readlink", "NULL");
                   ...
                   const char *device)
{
  ...
  r = guestfs___recv (g, "part_list", &hdr, &err,
        (protobuf_proc_unpack) guestfs_part_list_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "part_list", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this */
  ret_v = safe_malloc (g, sizeof (guestfs_partition))
;  convert_guestfs_partition_protobuf_to_xdr (ret->partitions, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "part_list");
                   ...
                   const char *vgname)
{
  ...
  r = guestfs___recv (g, "vgpvuuids", &hdr, &err,
        (protobuf_proc_unpack) guestfs_vgpvuuids_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "vgpvuuids", "NULL");
               ...
               const char *device)
{
  ...
  r = guestfs___recv (g, "is_lv", &hdr, &err,
        (protobuf_proc_unpack) guestfs_is_lv_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "is_lv", "-1");
                              ...
                              const struct guestfs_is_chardev_opts_argv *optargs)
{
  ...
  r = guestfs___recv (g, "is_chardev", &hdr, &err,
        (protobuf_proc_unpack) guestfs_is_chardev_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "is_chardev", "-1");
                             ...
                             const struct guestfs_is_socket_opts_argv *optargs)
{
  ...
  r = guestfs___recv (g, "is_socket", &hdr, &err,
        (protobuf_proc_unpack) guestfs_is_socket_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "is_socket", "-1");
                     ...
                     const char *partition)
{
  ...
  r = guestfs___recv (g, "part_to_dev", &hdr, &err,
        (protobuf_proc_unpack) guestfs_part_to_dev_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "part_to_dev", "NULL");
                       ...
                       int64_t offset)
{
  ...
  r = guestfs___recv (g, "pwrite_device", &hdr, &err,
        (protobuf_proc_unpack) guestfs_pwrite_device_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "pwrite_device", "-1");
                     ...
                     const char *file)
{
  ...
  r = guestfs___recv (g, "get_e2attrs", &hdr, &err,
        (protobuf_proc_unpack) guestfs_get_e2attrs_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "get_e2attrs", "NULL");
                          ...
                          const char *file)
{
  ...
  r = guestfs___recv (g, "get_e2generation", &hdr, &err,
        (protobuf_proc_unpack) guestfs_get_e2generation_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "get_e2generation", "-1");
...
guestfs_utsname (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "utsname", &hdr, &err,
        (protobuf_proc_unpack) guestfs_utsname_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "utsname", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this */
  ret_v = safe_malloc (g, sizeof (guestfs_utsname))
;  convert_guestfs_utsname_protobuf_to_xdr (ret->uts, ret_v);
  if (trace_flag) {
    guestfs___trace_open (&trace_buffer);
    fprintf (trace_buffer.fp, "%s = ", "utsname");
                              ...
                              const char *key)
{
  ...
  r = guestfs___recv (g, "hivex_node_get_value", &hdr, &err,
        (protobuf_proc_unpack) guestfs_hivex_node_get_value_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "hivex_node_get_value", "-1");
                              ...
                              const char *name)
{
  ...
  r = guestfs___recv (g, "hivex_node_add_child", &hdr, &err,
        (protobuf_proc_unpack) guestfs_hivex_node_add_child_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "hivex_node_add_child", "-1");
                              ...
                              char *const *devices)
{
  ...
  r = guestfs___recv (g, "ldmtool_scan_devices", &hdr, &err,
        (protobuf_proc_unpack) guestfs_ldmtool_scan_devices_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "ldmtool_scan_devices", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_guids + 1))
  for (i = 0; i < n_guids; ++i) {
              ...
              const char *dest)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_CP_R,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_cp_r_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "cp_r", "-1");
                   ...
                   const char *augpath)
{
  ...
  r = guestfs___recv (g, "aug_label", &hdr, &err,
        (protobuf_proc_unpack) guestfs_aug_label_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "aug_label", "NULL");
                          ...
                          const char *device)
{
  ...
  r = guestfs___recv (g, "blkdiscardzeroes", &hdr, &err,
        (protobuf_proc_unpack) guestfs_blkdiscardzeroes_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "blkdiscardzeroes", "-1");
                ...
                const char *path)
{
  ...
  r = guestfs___recv (g, "statns", &hdr, &err,
        (protobuf_proc_unpack) guestfs_statns_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "statns", "NULL");
