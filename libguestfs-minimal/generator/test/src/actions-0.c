            ...
            const char *directory)
{
  ...
  r = guestfs___recv (g, "ll", &hdr, &err,
        (protobuf_proc_unpack) guestfs_ll_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "ll", "NULL");
...
guestfs_pvs (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "pvs", &hdr, &err,
        (protobuf_proc_unpack) guestfs_pvs_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "pvs", "NULL");
...
//    free (err.errno_string);
  ...
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_physvols + 1))
  for (i = 0; i < n_physvols; ++i) {
     ret_v[i] = safe_strdup (g, ret->physvols[i]);
  }
  ret_v[n_physvols] = NULL;
  if (trace_flag) {
    size_t i;
                   ...
                   const char *augpath)
{
  ...
  r = guestfs___recv (g, "aug_match", &hdr, &err,
        (protobuf_proc_unpack) guestfs_aug_match_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "aug_match", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_matches + 1))
  for (i = 0; i < n_matches; ++i) {
     ret_v[i] = safe_strdup (g, ret->matches[i]);
  }
  ret_v[n_matches] = NULL;
  if (trace_flag) {
    size_t i;
                ...
                const char *augpath)
{
  ...
  r = guestfs___recv (g, "aug_ls", &hdr, &err,
        (protobuf_proc_unpack) guestfs_aug_ls_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "aug_ls", "NULL");
                       ...
                       char *const *arguments)
{
  ...
  r = guestfs___recv (g, "command_lines", &hdr, &err,
        (protobuf_proc_unpack) guestfs_command_lines_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "command_lines", "NULL");
              ...
              const char *device)
{
  ...
  r = guestfs___recv (g, "fsck", &hdr, &err,
        (protobuf_proc_unpack) guestfs_fsck_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "fsck", "-1");
...
guestfs_sfdisk_l (guestfs_h *g,
                  const char *device)
{
  guestfs_sfdisk_l_args args;
  guestfs_message_header *hdr;
  guestfs_message_error *err;
  guestfs_sfdisk_l_ret *ret;
  int serial;
  int r;
  int trace_flag = g->trace;
  struct trace_buffer trace_buffer;
  ...
  serial = guestfs___send (g, GUESTFS_PROC_SFDISK_L,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_sfdisk_l_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "sfdisk_l", "NULL");
  ...
  r = guestfs___recv (g, "sfdisk_l", &hdr, &err,
        (protobuf_proc_unpack) guestfs_sfdisk_l_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "sfdisk_l", "NULL");
...
guestfs_wc_w (guestfs_h *g,
              const char *path)
{
  guestfs_wc_w_args args;
  guestfs_message_header *hdr;
  guestfs_message_error *err;
  guestfs_wc_w_ret *ret;
  int serial;
  int r;
  int trace_flag = g->trace;
  struct trace_buffer trace_buffer;
  ...
  serial = guestfs___send (g, GUESTFS_PROC_WC_W,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_wc_w_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "wc_w", "-1");
  ...
  r = guestfs___recv (g, "wc_w", &hdr, &err,
        (protobuf_proc_unpack) guestfs_wc_w_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "wc_w", "-1");
...
guestfs_df_h (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "df_h", &hdr, &err,
        (protobuf_proc_unpack) guestfs_df_h_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "df_h", "NULL");
                 ...
                 const char *path)
{
  ...
  r = guestfs___recv (g, "zfgrepi", &hdr, &err,
        (protobuf_proc_unpack) guestfs_zfgrepi_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "zfgrepi", "NULL");
              ...
              const char *linkname)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_LN_F,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_ln_f_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "ln_f", "-1");
              ...
              const char *linkname)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_LN_S,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_ln_s_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "ln_s", "-1");
                           ...
                           const char *device)
{
  ...
  r = guestfs___recv (g, "part_get_parttype", &hdr, &err,
        (protobuf_proc_unpack) guestfs_part_get_parttype_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "part_get_parttype", "NULL");
                ...
                const char *vgname)
{
  ...
  r = guestfs___recv (g, "vguuid", &hdr, &err,
        (protobuf_proc_unpack) guestfs_vguuid_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "vguuid", "NULL");
                ...
                int64_t offset)
{
  ...
  r = guestfs___recv (g, "pwrite", &hdr, &err,
        (protobuf_proc_unpack) guestfs_pwrite_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "pwrite", "-1");
                   ...
                   const char *mountable)
{
  ...
  r = guestfs___recv (g, "vfs_label", &hdr, &err,
        (protobuf_proc_unpack) guestfs_vfs_label_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "vfs_label", "NULL");
                     ...
                     const char *device)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_RESIZE2FS_M,
                           progress_hint, 0,
                           (protobuf_proc_pack) guestfs_resize2fs_M_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "resize2fs_M", "-1");
                       ...
                       const struct guestfs_mount_9p_argv *optargs)
{
  ...
  serial = guestfs___send (g, GUESTFS_PROC_MOUNT_9P,
                           ...
                           (protobuf_proc_pack) guestfs_mount_9p_args__pack, (char *) &args);
  if (serial == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mount_9p", "-1");
                ...
                size_t *size_r)
{
  ...
  r = guestfs___recv (g, "vgmeta", &hdr, &err,
        (protobuf_proc_unpack) guestfs_vgmeta_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "vgmeta", "NULL");
                              ...
                              const char *name)
{
  ...
  r = guestfs___recv (g, "hivex_node_get_child", &hdr, &err,
        (protobuf_proc_unpack) guestfs_hivex_node_get_child_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "hivex_node_get_child", "-1");
                         ...
                         int64_t valueh)
{
  ...
  r = guestfs___recv (g, "hivex_value_key", &hdr, &err,
        (protobuf_proc_unpack) guestfs_hivex_value_key_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "hivex_value_key", "NULL");
                          ...
                          int64_t valueh)
{
  ...
  r = guestfs___recv (g, "hivex_value_type", &hdr, &err,
        (protobuf_proc_unpack) guestfs_hivex_value_type_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "hivex_value_type", "-1");
                                ...
                                const char *diskgroup)
{
  ...
  r = guestfs___recv (g, "ldmtool_diskgroup_name", &hdr, &err,
        (protobuf_proc_unpack) guestfs_ldmtool_diskgroup_name_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "ldmtool_diskgroup_name", "NULL");
                                   ...
                                   const char *diskgroup)
{
  ...
  r = guestfs___recv (g, "ldmtool_diskgroup_volumes", &hdr, &err,
        (protobuf_proc_unpack) guestfs_ldmtool_diskgroup_volumes_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "ldmtool_diskgroup_volumes", "NULL");
...
//    free (err.errno_string);
  ...
  /* caller will free this, but we need to add a NULL entry */
  ret_v = safe_malloc (g, sizeof (char *) * (ret->n_volumes + 1))
  for (i = 0; i < n_volumes; ++i) {
     ret_v[i] = safe_strdup (g, ret->volumes[i]);
  }
  ret_v[n_volumes] = NULL;
  if (trace_flag) {
    size_t i;
...
guestfs_journal_get_data_threshold (guestfs_h *g)
{
  ...
  r = guestfs___recv (g, "journal_get_data_threshold", &hdr, &err,
        (protobuf_proc_unpack) guestfs_journal_get_data_threshold_ret__unpack, (char *) &ret);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "journal_get_data_threshold", "-1");
